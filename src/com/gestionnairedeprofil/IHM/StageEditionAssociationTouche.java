...
public class StageEditionAssociationTouche extends Stage
{
    ...
    public StageEditionAssociationTouche(final double i, final StageEditionProfil profilConcerne, final int numDuBtnAModifier)
    {
        ...
        this.setTitle(Langue.getLangue().getString("StageEditionAssociationTouche_title"));
        ...
        texteTypeAssoc.setText(Langue.getLangue().getString("StageEditionAssociationTouche_texteTypeAssoc"));

        // Configuration des contrôles

        Button btnAnnulerModifs = new Button(Langue.getLangue().getString("StageEditionAssociationTouche_btnAnnulerModifs"), new ImageView(new Image(getClass().getResourceAsStream("ressourcesGraphiques/cancel.png"))));
        ...
        Button btnModifier = new Button(Langue.getLangue().getString("StageEditionAssociationTouche_btnModifier"), new ImageView(new Image(getClass().getResourceAsStream("ressourcesGraphiques/ok.png"))));
        ...
        this.cbTypeAssoc.getItems().addAll(Langue.getLangue().getString("StageEditionAssociationTouche_cbTypeAssocA"),
                Langue.getLangue().getString("StageEditionAssociationTouche_cbTypeAssocB"),
                Langue.getLangue().getString("StageEditionAssociationTouche_cbTypeAssocC"),
                Langue.getLangue().getString("StageEditionAssociationTouche_cbTypeAssocD"),
                Langue.getLangue().getString("StageEditionAssociationTouche_cbTypeAssocE"));
