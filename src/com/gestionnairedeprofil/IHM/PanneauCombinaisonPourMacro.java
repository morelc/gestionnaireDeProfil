...
public class PanneauCombinaisonPourMacro extends AnchorPane implements InterfacePanneauTypeCombinaison
{
    ...
    public PanneauCombinaisonPourMacro(double i, final PanneauEditionMacro panneauParent, ArrayList<ToucheMachine> touchesDisponibles, Association associationDeBase)
    {
        ...
        texeTimer.setText(Langue.getLangue().getString("CombinaisonForMacroPane_textTimer"));
        ...
        texeTimerBis.setText(Langue.getLangue().getString("CombinaisonForMacroPane_textTimerBis"));
        ...
        texteCombinaison.setText(Langue.getLangue().getString("CombinaisonForMacroPane_textCombinaison"));
        ...
        this.btnAjouterCmb = new Button(Langue.getLangue().getString("CombinaisonForMacroPane_btnAddCmb"), new ImageView(new Image(getClass().getResourceAsStream("ressourcesGraphiques/add.png"))));
        ...
        infobulleBtnAjouterCmb.setText(Langue.getLangue().getString("CombinaisonForMacroPane_infobulleBtnAddCmb"));
        this.btnAjouterCmb.setTooltip(infobulleBtnAjouterCmb);
        this.getChildren().add(this.btnAjouterCmb);

        this.btnPremiereAssoc = new Button(Langue.getLangue().getString("CombinaisonForMacroPane_btnFirstAssoc"), new ImageView(new Image(getClass().getResourceAsStream("ressourcesGraphiques/dLeft.png"))));
        ...
        infobulleBtnPremiereAssoc.setText(Langue.getLangue().getString("CombinaisonForMacroPane_infobulleBtnFirstAssoc"));
        this.btnPremiereAssoc.setTooltip(infobulleBtnPremiereAssoc);
        this.getChildren().add(this.btnPremiereAssoc);

        this.btnAssocPrecedente = new Button(Langue.getLangue().getString("CombinaisonForMacroPane_btnAssocPrevious"), new ImageView(new Image(getClass().getResourceAsStream("ressourcesGraphiques/left.png"))));
        ...
        infobulleBtnAssocPrecedente.setText(Langue.getLangue().getString("CombinaisonForMacroPane_infobulleBtnAssocPrevious"));
        this.btnAssocPrecedente.setTooltip(infobulleBtnAssocPrecedente);
        this.getChildren().add(this.btnAssocPrecedente);

        this.btnAssocSuivante = new Button(Langue.getLangue().getString("CombinaisonForMacroPane_btnAssocNext"), new ImageView(new Image(getClass().getResourceAsStream("ressourcesGraphiques/right.png"))));
        ...
        infobulleBtnAssocSuivante.setText(Langue.getLangue().getString("CombinaisonForMacroPane_infobulleBtnAssocNext"));
        this.btnAssocSuivante.setTooltip(infobulleBtnAssocSuivante);
        this.getChildren().add(this.btnAssocSuivante);

        this.btnDerniereAssoc = new Button(Langue.getLangue().getString("CombinaisonForMacroPane_btnLastAssoc"), new ImageView(new Image(getClass().getResourceAsStream("ressourcesGraphiques/dRight.png"))));
        ...
        infobulleBtnDerniereAssoc.setText(Langue.getLangue().getString("CombinaisonForMacroPane_infobulleBtnLastAssoc"));
        this.btnDerniereAssoc.setTooltip(infobulleBtnDerniereAssoc);
        this.getChildren().add(this.btnDerniereAssoc);

        Button btnCreerAssoc = new Button(Langue.getLangue().getString("CombinaisonForMacroPane_btnCreateAssoc"), new ImageView(new Image(getClass().getResourceAsStream("ressourcesGraphiques/add.png"))));
        ...
        infobulleBtnCreerAssoc.setText(Langue.getLangue().getString("CombinaisonForMacroPane_infobulleBtnCreateAssoc"));
        btnCreerAssoc.setTooltip(infobulleBtnCreerAssoc);
        this.getChildren().add(btnCreerAssoc);

        this.btnSupprimerAssoc = new Button(Langue.getLangue().getString("CombinaisonForMacroPane_btnDeleteAssoc"), new ImageView(new Image(getClass().getResourceAsStream("ressourcesGraphiques/del.png"))));
        ...
        infobulleBtnSupprimerAssoc.setText(Langue.getLangue().getString("CombinaisonForMacroPane_infobulleBtnDeleteAssoc"));
